      ...
      return {
        ...
        label: (
          <div className="text-left w-80 sm:w-96">
            <h1 className="truncate text-red-600">{chiNhanh.tenCumRap}</h1>
            <p className="truncate text-white">{chiNhanh.diaChi}</p>
          </div>
        ),
        ...
        {lichChieu.slice(0, 6).map((lich) => {
          return (
            <div
              ...
              className="bg-white hover:bg-red-600 hover:text-white px-2 py-2 rounded border border-gray-200 text-center  transition cursor-pointer"
            >
  ...
  return (
    <div className="bg-black">
      <div className="container mx-auto">
        <div
          className="py-20 flex flex-col items-center px-4 md:px-8"
          id="cumRapSection"
        >
